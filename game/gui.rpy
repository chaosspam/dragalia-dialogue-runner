...
define gui.accent_color = u'#66c1e0'
...
define gui.text_color = u'#012231'
define gui.interface_text_color = u'#424242'


## Fonts and Font Sizes ########################################################

## The font used for in-game text.
define gui.text_font = "fonts/dragalialosten.ttf"

## The font used for character names.
define gui.name_text_font = "fonts/dragalialosten.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "fonts/dragalialosten.ttf"
...
define gui.textbox_height = 1334
...
## center.
define gui.dialogue_xpos = 75
define gui.dialogue_ypos = 900
...
define gui.choice_button_borders = Borders(59, 3, 59, 3)
...
define gui.slot_button_width = 290
define gui.slot_button_height = 528
define gui.slot_button_borders = Borders(24, 16, 24, 0)
...
define config.thumbnail_height = 444
...
define gui.confirm_frame_borders = Borders(24, 24, 24, 24)

## The frame that is used as part of the skip screen.
define gui.skip_frame_borders = Borders(10, 3, 30, 3)

## The frame that is used as part of the notify screen.
define gui.notify_frame_borders = Borders(10, 3, 24, 3)
...
define gui.slider_borders = Borders(15, 0, 15, 0)

## Vertical borders.
define gui.vbar_borders = Borders(0, 0, 0, 0)
define gui.vscrollbar_borders = Borders(3, 3, 3, 3)
define gui.vslider_borders = Borders(15, 0, 15, 0)
...
## speaking character.
define gui.history_name_xpos = 32
define gui.history_name_ypos = 0
define gui.history_name_width = 1
define gui.history_name_xalign = 1.0

## The position, width, and alignment of the dialogue text.
define gui.history_text_xpos = 64
define gui.history_text_ypos = 2
define gui.history_text_width = 434
...
## The position, width, and alignment of the label giving the name of the
## speaking character.
define gui.nvl_name_xpos = 252
define gui.nvl_name_ypos = 0
define gui.nvl_name_width = 88
define gui.nvl_name_xalign = 1.0

## The position, width, and alignment of the dialogue text.
define gui.nvl_text_xpos = 264
define gui.nvl_text_ypos = 5
define gui.nvl_text_width = 346
define gui.nvl_text_xalign = 0.0

## The position, width, and alignment of nvl_thought text (the text said by the
## nvl_narrator character.)
define gui.nvl_thought_xpos = 141
define gui.nvl_thought_ypos = 0
define gui.nvl_thought_width = 458
define gui.nvl_thought_xalign = 0.0

## The position of nvl menu_buttons.
define gui.nvl_button_xpos = 264
...
init python:
    ...
    def touch():
        ...
        gui.quick_button_borders = Borders(24, 9, 24, 0)
    ...
    def small():
        ...
        gui.button_text_size = 18
        gui.label_text_size = 20

        ## Adjust the location of the textbox.
        gui.textbox_height = 141
        gui.name_xpos = 47
        gui.dialogue_xpos = 53
        gui.dialogue_width = 645

        ## Change the size and spacing of various things.
        gui.slider_size = 22

        gui.choice_button_width = 727
        gui.choice_button_text_size = 18

        gui.navigation_spacing = 12
        gui.pref_button_spacing = 6

        gui.history_height = 112
        gui.history_text_width = 405
        ...
        gui.nvl_name_width = 179
        gui.nvl_name_xpos = 191

        gui.nvl_text_width = 537
        gui.nvl_text_xpos = 203
        gui.nvl_text_ypos = 3

        gui.nvl_thought_width = 727
        gui.nvl_thought_xpos = 12

        gui.nvl_button_width = 727
